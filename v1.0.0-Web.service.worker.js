...
const CACHE_NAME = "v1.0.0-Web-cache";
const OFFLINE_URL = "v1.0.0-Web.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["v1.0.0-Web.html","v1.0.0-Web.js","v1.0.0-Web.wasm","v1.0.0-Web.pck","v1.0.0-Web.offline.html","v1.0.0-Web.icon.png","v1.0.0-Web.apple-touch-icon.png"];
